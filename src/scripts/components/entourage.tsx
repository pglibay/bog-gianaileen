...
const PageOne = () => {
    const prinipalSponsors = {
        ...
        female: ["Mrs. Irene O. Alaan", "Engr. Erlinda A. Apale", "Mrs. Rosario Fe G. Baluran", "Mrs. Conception Caybot", "Mrs. Peregrina C. Daquio", "Mrs. Rosette M. Garcia", "Mrs. Judy U. Jabajab", "Mrs. Milagros B. Israel", "Mrs. Maria Carmen B. Labunog", "Mrs. Merlyn P. Lancila", "Mrs. Lea M. Locot", "Mrs. Loreto T. Namor, CPA", "Mrs. Rowena A. Narbay", "Mrs. Gloricil P. Fudalan", "Mrs. Ma. Cecilia N. Raut", "Mrs. Venus I. Iyog", "Ms. Daisy L. Israel", "Mrs. Marciana B. Romuga", "Mrs. Jean C. Saturinas", "Mrs. Marlyn L. Suarez", "Ms. Ana Fe M. Manding", "Mrs. Clarice Elaine B. Davila"]
    };
